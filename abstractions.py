...
def make_restaurant(name, location, categories, price, reviews):
    ...
    # The "reviews" key and its values are created in the same way as other parameters
...
def restaurant_ratings(restaurant):
    ...
    # Return the value associated with the "reviews" key
...
def restaurant_num_ratings(restaurant):
    ...
    # Return the length of the list of restaurant ratings
...
def restaurant_mean_rating(restaurant):
    ...
    # Return the mean of ratings by adding all ratings together 
    # and dividing the number of ratings
