...
def map_and_filter(s, map_fn, filter_fn):
    ...
    # Apply function map_fn for all the elements in s if filter_fn returns True.
...
def key_of_min_value(d):
    ...
    # The function in Key gets the value associated with the key in d
...
def enumerate(s, start=0):
    ...
    """
    "*** YOUR CODE HERE ***"
    return [[start + i] + zip(s)[i] for i in range(len(s))]
    # Combine the index "start + i" with the ith element of the sequence
